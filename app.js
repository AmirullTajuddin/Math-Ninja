...
function evaluateModeLock(mode){
 ...
 let spread=maxTime===0?0:(maxTime-minTime)/maxTime;
...
function openReport(){
 ...
 <h3>Password Room</h3>
 <p class="ranking-note">Ruang ini disediakan untuk password parent pada versi seterusnya.</p>
 <input placeholder="Parent password coming soon" disabled>
 </div>
