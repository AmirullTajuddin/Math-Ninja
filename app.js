...
function savePerfectScore(mode,timeTaken){
 let name=prompt("Tahniah! Masukkan nama pemain untuk ranking:","");
 if(name===null)return;
...
function submitQuiz(){
 ...
 if(all){
  savePerfectScore(currentMode,timeTaken);
 }
...
function openRanking(){
 ...
 let html="<h2>Top 10 Ranking</h2><p class='ranking-note'>Ranking direkod hanya bila semua 50 jawapan betul.</p>";
